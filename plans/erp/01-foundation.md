...
composes/erp/server/
  ...
  src/
    ...
    db/
      schema/
        erp.ts         all 38 Drizzle table definitions
      seed/
...
|--------|--------|---------|
| Vendor | `vnd` | `vnd_01ARZ...` |
| Purchase Requisition | `pr` | `pr_01ARZ...` |
| PR Item | `pri` | `pri_01ARZ...` |
| Purchase Order | `po` | `po_01ARZ...` |
| PO Item | `poi` | `poi_01ARZ...` |
| Goods Receipt | `grn` | `grn_01ARZ...` |
| GR Item | `gri` | `gri_01ARZ...` |
| Vendor Invoice | `vbi` | `vbi_01ARZ...` |
| Vendor Invoice Item | `vii` | `vii_01ARZ...` |
| Payment Voucher | `pmt` | `pmt_01ARZ...` |
| Customer | `cst` | `cst_01ARZ...` |
| Quotation | `qtn` | `qtn_01ARZ...` |
| Sales Order | `sod` | `sod_01ARZ...` |
| Delivery Note | `dn` | `dn_01ARZ...` |
| Sales Invoice | `si` | `si_01ARZ...` |
| Item | `itm` | `itm_01ARZ...` |
| Warehouse | `wh` | `wh_01ARZ...` |
| Stock Entry | `ste` | `ste_01ARZ...` |
| Account (CoA) | `acc` | `acc_01ARZ...` |
| Fiscal Year | `fy` | `fy_01ARZ...` |
| Journal Entry | `je` | `je_01ARZ...` |
| Bank Account | `bka` | `bka_01ARZ...` |
| BOM | `bom` | `bom_01ARZ...` |
| Work Order | `wo` | `wo_01ARZ...` |
| Employee | `emp` | `emp_01ARZ...` |

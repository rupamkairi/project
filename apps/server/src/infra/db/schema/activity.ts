...
export const activityStatusEnum = pgEnum('activity_status', ['pending', 'done', 'cancelled'])
...
export const activities = pgTable(
  ...
  (table) => [
    ...
    index('activities_org_status_due_idx').on(table.organizationId, table.status, table.dueAt),
  ],
)

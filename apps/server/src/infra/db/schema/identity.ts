...
export const actorTypeEnum = pgEnum('actor_type', ['human', 'system', 'api_key'])
export const actorStatusEnum = pgEnum('actor_status', ['pending', 'active', 'suspended', 'deleted'])
...
export const roles = pgTable(
  ...
  (table) => [uniqueIndex('roles_org_name_idx').on(table.organizationId, table.name)],
)

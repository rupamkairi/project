  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'GMV', value: analytics.gmv ?? 0, delta: '+18%' },
          { label: 'Orders', value: analytics.orderCount ?? 0, delta: '+12%' },
          { label: 'AOV', value: analytics.aov ?? 0, delta: '+5%' },
          { label: 'Return Rate', value: analytics.returnRate ?? '0%', delta: '-1%' },
        ].map((kpi) => (

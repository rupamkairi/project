        ...
        <div className="aspect-square rounded-xl bg-zinc-100 dark:bg-zinc-800 overflow-hidden relative mb-3">
          ...
          {!product.isAvailable && (
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <span className="text-white text-xs font-medium px-3 py-1 rounded-full bg-black/60">
                Out of Stock
              </span>
            </div>
          )}
      ...
      <div className="space-y-1 px-0.5">
        ...
        {onAddToCart && (
          <Button
            variant="outline"
            size="sm"
            className="w-full mt-2 h-8 text-xs opacity-0 group-hover:opacity-100 transition-opacity"

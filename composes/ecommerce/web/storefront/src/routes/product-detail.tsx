    ...
    return (
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <Button variant="outline" className="mt-4" asChild>
          <Link to="/ecommerce/store/products">Back to Products</Link>
        </Button>
      </div>
    )
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-lg bg-muted/50 p-4 space-y-2 text-sm">
            <div className="flex items-center gap-2">
              <Truck className="h-4 w-4 text-muted-foreground" /> Free shipping on orders over{' '}
              {formatCurrency(5000)}
            </div>
            <div className="flex items-center gap-2">
              <RotateCcw className="h-4 w-4 text-muted-foreground" /> Easy 30-day returns
            </div>
          </div>
        </div>
      </div>

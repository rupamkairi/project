...
export const erpPrItem = pgTable('erp_pr_items', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('pri')),
  requisitionId: text('requisition_id')
    .notNull()
    .references(() => erpPurchaseRequisition.id),
...
export const erpGrn = pgTable('erp_grns', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('grn')),
  organizationId: text('organization_id').notNull(),
...
export const erpGrnItem = pgTable('erp_grn_items', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('gri')),
  grnId: text('grn_id')
    .notNull()
    .references(() => erpGrn.id),
  itemId: text('item_id').notNull(),
...
export const erpDeliveryNote = pgTable('erp_delivery_notes', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('dn')),
  organizationId: text('organization_id').notNull(),
...
export const erpDnItem = pgTable('erp_dn_items', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('dni')),
  dnId: text('dn_id')
    .notNull()
    .references(() => erpDeliveryNote.id),
...
export const erpStockEntry = pgTable('erp_stock_entries', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('ste')),
  organizationId: text('organization_id').notNull(),
...
export const erpStockEntryItem = pgTable('erp_stock_entry_items', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('sei')),
  entryId: text('entry_id')
    .notNull()
    .references(() => erpStockEntry.id),
  itemId: text('item_id').notNull(),
...
export const erpFiscalYear = pgTable('erp_fiscal_years', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('fy')),
  organizationId: text('organization_id').notNull(),
...
export const erpBankAccount = pgTable('erp_bank_accounts', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('bka')),
  organizationId: text('organization_id').notNull(),
...
export const erpBankTransaction = pgTable('erp_bank_transactions', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('btx')),
  bankAccountId: text('bank_account_id')
    .notNull()
    .references(() => erpBankAccount.id),
  date: timestamp('date').notNull(),
...
export const erpAsset = pgTable('erp_assets', {
  ...
  accumulatedDepreciation: numeric('accumulated_depreciation', { precision: 15, scale: 2 }).default(
    '0',
  ),
...
export const erpAssetDepreciation = pgTable('erp_asset_depreciation', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('adp')),
  assetId: text('asset_id')
    .notNull()
    .references(() => erpAsset.id),
...
export const erpGstTemplate = pgTable('erp_gst_templates', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('gst')),
  organizationId: text('organization_id').notNull(),
  name: text('name').notNull(),
  type: text('type').notNull(),
...
export const erpGstReturn = pgTable('erp_gst_returns', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => generatePrefixedId('grt')),
  organizationId: text('organization_id').notNull(),
  type: text('type').notNull(),
  period: text('period').notNull(),

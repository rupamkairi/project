...
function TaxPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button size="sm" variant="outline" onClick={loadGstr1}>
              Preview
            </Button>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button size="sm" variant="outline" onClick={loadGstr3b}>
              Preview
            </Button>
          </CardHeader>
          <CardContent>
            {!gstr3bPreview ? (
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>
                    ₹{Number(gstr3bPreview.outward_taxable_supplies?.igst ?? 0).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span>
                    ₹
                    {(
                      Number(gstr3bPreview.outward_taxable_supplies?.cgst ?? 0) +
                      Number(gstr3bPreview.outward_taxable_supplies?.sgst ?? 0)
                    ).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-destructive">
                    ₹
                    {(Object.values(gstr3bPreview.tax_payable ?? {}) as number[])
                      .reduce((s, v) => s + v, 0)
                      .toLocaleString()}
                  </span>
                </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>GST Templates</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (

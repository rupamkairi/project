...
import { ShoppingCart, TrendingUp, Package, DollarSign, Factory, FileText } from 'lucide-react'
...
const MODULES = [
  {
    ...
    icon: ShoppingCart,
    desc: 'Vendors, POs, GRNs, invoices',
  },
  {
    label: 'Sales',
    href: '/erp/sales',
    icon: TrendingUp,
    desc: 'Customers, orders, delivery, invoicing',
  },
  {
    label: 'Inventory',
    href: '/erp/inventory',
    icon: Package,
    desc: 'Items, warehouses, stock ledger',
  },
  {
    label: 'Finance',
    href: '/erp/finance',
    icon: DollarSign,
    desc: 'GL, journal entries, reports',
  },
  {
    label: 'Manufacturing',
    href: '/erp/manufacturing',
    icon: Factory,
    desc: 'BOMs, work orders, production',
  },

...
class ErpApiClient {
  ...
  vendors = {
    ...
    update: (id: string, body: any) =>
      this.request(`/vendors/${id}`, { method: 'PATCH', body: JSON.stringify(body) }),
    approve: (id: string) => this.request(`/vendors/${id}/approve`, { method: 'POST' }),
    blacklist: (id: string, body: any) =>
      this.request(`/vendors/${id}/blacklist`, { method: 'POST', body: JSON.stringify(body) }),
  }
  ...
  purchaseRequisitions = {
    ...
    create: (body: any) =>
      this.request('/purchase-requisitions', { method: 'POST', body: JSON.stringify(body) }),
    submit: (id: string) => this.request(`/purchase-requisitions/${id}/submit`, { method: 'POST' }),
    approve: (id: string) =>
      this.request(`/purchase-requisitions/${id}/approve`, { method: 'POST' }),
    reject: (id: string, body: any) =>
      this.request(`/purchase-requisitions/${id}/reject`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    convertToPo: (id: string) =>
      this.request(`/purchase-requisitions/${id}/convert-to-po`, { method: 'POST' }),
  }
  ...
  purchaseOrders = {
    ...
    create: (body: any) =>
      this.request('/purchase-orders', { method: 'POST', body: JSON.stringify(body) }),
  ...
  goodsReceipts = {
    ...
    create: (body: any) =>
      this.request('/goods-receipts', { method: 'POST', body: JSON.stringify(body) }),
  ...
  vendorInvoices = {
    ...
    create: (body: any) =>
      this.request('/vendor-invoices', { method: 'POST', body: JSON.stringify(body) }),
  ...
  payments = {
    ...
    create: (body: any) =>
      this.request('/payments', { method: 'POST', body: JSON.stringify(body) }),
  }
  ...
  customers = {
    ...
    create: (body: any) =>
      this.request('/customers', { method: 'POST', body: JSON.stringify(body) }),
    update: (id: string, body: any) =>
      this.request(`/customers/${id}`, { method: 'PATCH', body: JSON.stringify(body) }),
  }

  quotations = {
    list: () => this.request('/quotations'),
    create: (body: any) =>
      this.request('/quotations', { method: 'POST', body: JSON.stringify(body) }),
    convertToSo: (id: string) =>
      this.request(`/quotations/${id}/convert-to-so`, { method: 'POST' }),
  }
  ...
  salesOrders = {
    ...
    create: (body: any) =>
      this.request('/sales-orders', { method: 'POST', body: JSON.stringify(body) }),
  ...
  deliveryNotes = {
    ...
    create: (body: any) =>
      this.request('/delivery-notes', { method: 'POST', body: JSON.stringify(body) }),
  ...
  salesInvoices = {
    ...
    create: (body: any) =>
      this.request('/sales-invoices', { method: 'POST', body: JSON.stringify(body) }),
  ...
  warehouses = {
    ...
    create: (body: any) =>
      this.request('/warehouses', { method: 'POST', body: JSON.stringify(body) }),
  ...
  stock = {
    ...
    movements: (itemId?: string) =>
      this.request(`/stock/movements${itemId ? `?itemId=${itemId}` : ''}`),
  }
  ...
  accounts = {
    ...
    create: (body: any) =>
      this.request('/accounts', { method: 'POST', body: JSON.stringify(body) }),
    journalEntries: () => this.request('/journal-entries'),
    createJe: (body: any) =>
      this.request('/journal-entries', { method: 'POST', body: JSON.stringify(body) }),
  ...
  reports = {
    ...
    createFy: (body: any) =>
      this.request('/fiscal-years', { method: 'POST', body: JSON.stringify(body) }),
  ...
  workOrders = {
    ...
    create: (body: any) =>
      this.request('/work-orders', { method: 'POST', body: JSON.stringify(body) }),
  ...
  gst = {
    ...
    createTemplate: (body: any) =>
      this.request('/gst-templates', { method: 'POST', body: JSON.stringify(body) }),
    gstr1Preview: (period: string) => this.request(`/gst-returns/gstr1/preview?period=${period}`),
    generateGstr1: (body: any) =>
      this.request('/gst-returns/gstr1', { method: 'POST', body: JSON.stringify(body) }),
    gstr3bPreview: (period: string) => this.request(`/gst-returns/gstr3b/preview?period=${period}`),
    generateGstr3b: (body: any) =>
      this.request('/gst-returns/gstr3b', { method: 'POST', body: JSON.stringify(body) }),

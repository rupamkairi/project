...
export const crmCampaign = pgTable(
  ...
  (table) => [
    ...
    index('crm_campaigns_org_segment_idx').on(table.organizationId, table.segmentId),
  ],
)
...
export const crmCampaignContact = pgTable(
  ...
  (table) => [
    ...
    index('crm_campaign_contacts_org_campaign_idx').on(table.organizationId, table.campaignId),
    index('crm_campaign_contacts_org_person_idx').on(table.organizationId, table.personId),
  ],
)
...
export const crmEmailThread = pgTable(
  ...
  (table) => [
    index('crm_email_threads_org_person_idx').on(table.organizationId, table.personId),
    index('crm_email_threads_org_external_idx').on(table.organizationId, table.externalThreadId),
  ],
)
...
export const crmEmailMessage = pgTable(
  ...
  (table) => [index('crm_email_messages_org_thread_idx').on(table.organizationId, table.threadId)],
)

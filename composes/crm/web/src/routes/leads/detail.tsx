  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <ConfirmDialog
        ...
        title="Convert Lead"
        description="Convert this lead into a contact and deal. This cannot be undone."
      ...
      <Dialog open={disqualifyOpen} onOpenChange={setDisqualifyOpen}>
        <DialogContent className="sm:max-w-sm">
          ...
          <DialogFooter>
            <Button variant="outline" size="sm" onClick={() => setDisqualifyOpen(false)}>
              Cancel
            </Button>
            <Button size="sm" variant="destructive" onClick={handleDisqualify}>
              Disqualify
            </Button>
          </DialogFooter>
        </DialogContent>

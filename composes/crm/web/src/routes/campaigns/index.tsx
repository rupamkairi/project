  ...
  const CampaignFormContent = ({
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          value={fd.content}
          onChange={(e) => setFd({ ...fd, content: e.target.value })}
          rows={3}
        />
      </div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            type="date"
            value={fd.endDate}
            onChange={(e) => setFd({ ...fd, endDate: e.target.value })}
          />
        </div>
      </div>
    </div>
            ...
            {loading ? (
              ...
              campaigns.map((c) => (
                <TableRow
                  ...
                  onClick={() =>
                    navigate({ to: '/crm/campaigns/$campaignId', params: { campaignId: c.id } })
                  }
                >

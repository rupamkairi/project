                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  {account.email && (
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <a href={`mailto:${account.email}`} className="hover:text-foreground">
                        {account.email}
                      </a>
                    </div>
                  )}
                  ...
                  {contacts.length === 0 ? (
                    ...
                    contacts.map((c) => {
                      ...
                      return (
                        <div
                          key={c.id}
                          className="flex items-center gap-3 pb-3 border-b last:border-0 cursor-pointer hover:opacity-80"
                          onClick={() =>
                            navigate({
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            {d.stageName ?? 'Unknown stage'}
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium">
                            {d.value
                              ? `$${Number(d.value.amount ?? d.value).toLocaleString()}`
                              : '—'}
                          </p>

  ...
  return (
    <div className="p-6 space-y-4">
            ...
            {loading ? (
              ...
              accounts.map((a) => (
                <TableRow
                  ...
                  onClick={() =>
                    navigate({ to: '/crm/accounts/$accountId', params: { accountId: a.id } })
                  }
                >
                  <TableCell>
                  ...
                  <TableCell className="text-muted-foreground text-sm">
                    {a.employees ? a.employees.toLocaleString() : '—'}
                  </TableCell>
                  <TableCell>
      ...
      <ConfirmDialog
        ...
        description="This will remove the account and cannot be undone."
        confirmLabel="Delete"

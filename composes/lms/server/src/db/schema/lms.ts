...
export const contentTypeEnum = pgEnum('lms_content_type', ['video', 'text', 'pdf', 'embed', 'quiz'])

export const questionTypeEnum = pgEnum('lms_question_type', ['mcq', 'true_false', 'short_answer'])
...
export const couponDiscountTypeEnum = pgEnum('lms_coupon_discount_type', ['percentage', 'fixed'])
...
export const lmsLesson = pgTable(
  ...
  (table) => [
    ...
    index('lms_lessons_module_position_idx').on(
...
export const lmsAssignment = pgTable(
  ...
  (table) => [index('lms_assignments_module_idx').on(table.organizationId, table.moduleId)],
)
...
export const lmsQuiz = pgTable(
  ...
  (table) => [index('lms_quizzes_lesson_idx').on(table.organizationId, table.lessonId)],
)
...
export const lmsQuizQuestion = pgTable(
  ...
  (table) => [
    ...
    index('lms_quiz_questions_quiz_position_idx').on(
      table.organizationId,
      table.quizId,
      table.position,
    ),
...
export const lmsQuizSubmission = pgTable(
  ...
  (table) => [
    index('lms_quiz_submissions_quiz_person_idx').on(
      table.organizationId,
      table.quizId,
      table.personId,
    ),
...
export const lmsCertificate = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('lms_certificates_person_course_idx').on(
      table.organizationId,
      table.personId,
      table.itemId,
    ),
...
export const lmsCohortMember = pgTable(
  ...
  (table) => [
    uniqueIndex('lms_cohort_members_cohort_person_idx').on(
      table.organizationId,
      table.cohortId,
      table.personId,
    ),
...
export const lmsProgress = pgTable(
  ...
  (table) => [
    uniqueIndex('lms_progress_person_lesson_idx').on(
      table.organizationId,
      table.personId,
      table.lessonId,
    ),
...
export const lmsCourseReview = pgTable(
  ...
  (table) => [
    uniqueIndex('lms_course_reviews_course_reviewer_idx').on(
      table.organizationId,
      table.itemId,
      table.reviewerId,
    ),
...
export const lmsWaitlist = pgTable(
  ...
  (table) => [
    uniqueIndex('lms_waitlist_cohort_person_idx').on(
      table.organizationId,
      table.cohortId,
      table.personId,
    ),
...
export const lmsPaymentEvent = pgTable(
  ...
  (table) => [uniqueIndex('lms_payment_events_stripe_id_idx').on(table.stripeEventId)],
)
...
export const lmsOrgConfig = pgTable(
  ...
  (table) => [uniqueIndex('lms_org_config_org_idx').on(table.organizationId)],
)
